...
Spring Data JPA(자바 ORM기술 규격)는 JPA를 쓰기 편하게 만들어 놓은 모듈로써 JPA를 한 단계 추상화시킨 Repository라는 인터페이스를 제공 
...
Repository 인터페이스
	엔티티를 이용해서 CRUD를 처리하는 Repository
	DAO와 동일한 개념
	인터페이스 생성시 JPARepository add
	별도의 구현 클래스 없이 기능을 사용가능